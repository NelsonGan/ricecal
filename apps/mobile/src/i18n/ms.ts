...
export const ms = {
  ...
  logging: {
    ...
    detail: {
      ...
      partReplaced: '{{food}} ada pada pinggan sebagai gantinya',
      editKcal: 'Kalori',
  ...
  profile: {
    ...
    account: {
      ...
      saved: 'Nama disimpan',
      saveFailed: 'Nama tidak dapat disimpan',
      copy: 'Salin',
  ...
  paywall: {
    ...
    hard: {
      ...
      smallPrintYearly: '{{duration}} percuma, kemudian {{price}} setahun.',
      smallPrintMonthly: '{{duration}} percuma, kemudian {{price}} sebulan.',
      ...
      trialDuration: {
        ...
        year_one: '{{count}} tahun',
        year_other: '{{count}} tahun',
      },
    ...
    welcome: {
      ...
      body: 'Percubaan percuma anda berlangsung {{duration}}. Semuanya terbuka.',
      bodyTrialUnknown: 'Percubaan percuma anda bermula sekarang. Semuanya terbuka.',
  ...
  recipes: {
    ...
    edit: {
      ...
      stepLabel: 'Langkah {{count}}',
      stepPlaceholder: 'Apa yang dibuat dalam langkah ini?',
      addStep: 'Tambah langkah',
      removeStep: 'Buang langkah {{count}}',
      save: 'Simpan makanan',
