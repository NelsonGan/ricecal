...
export const ms = {
  social: {
    rejectedBody: 'Sunting teks atau foto, kemudian cuba lagi.',
    handleTaken: 'Nama pengguna ini sudah digunakan.',
    feed: 'Suapan',
    following: 'Mengikuti',
    discover: 'Teroka',
    myFoods: 'Makanan saya',
    people: 'Cari orang',
    suggestions: 'Orang untuk diikuti',
    ...
    back: 'Kembali',
    followers: 'Pengikut',
    posts_one: '{{count}} siaran',
    posts_other: '{{count}} siaran',
    ...
    caption: 'Kapsyen',
    captionPlaceholder: 'Ceritakan tentang makanan anda',
    audience: 'Siapa boleh lihat?',
    ...
    sourceDelete: 'Memadam makanan ini turut membuang siaran suapan dan komennya.',
    like: 'Suka',
    unlike: 'Batal suka',
    likes_one: '{{count}} suka',
    likes_other: '{{count}} suka',
    ...
    deleteCommentBody: 'Komen ini akan dibuang.',
    pending: 'Menunggu semakan',
    rejected: 'Perlu perubahan',
    quarantined: 'Dalam semakan',
    approved: 'Disiarkan',
    pendingBody: 'Hanya anda boleh melihatnya sehingga diluluskan.',
    retryReview: 'Semak semula',
    block: 'Sekat',
    blockBody: 'Anda tidak lagi dapat melihat satu sama lain di sini. Hubungan mengikuti dibuang.',
    blocked: 'Orang disekat',
    unblock: 'Nyahsekat',
    unblockBody: 'Hubungan mengikuti tidak akan dipulihkan.',
    report: 'Lapor',
    reported: 'Dilaporkan',
    ...
    unread: 'Belum dibaca',
    unreadNotifications_one: '{{count}} pemberitahuan belum dibaca',
    unreadNotifications_other: '{{count}} pemberitahuan belum dibaca',
    unreadNotificationsOverflow: '99 atau lebih pemberitahuan belum dibaca',
    markRead: 'Tandakan dibaca',
    notificationFollow: '{{name}} mengikuti anda',
    notificationLike: '{{name}} menyukai siaran anda',
    notificationComment: '{{name}} mengomen siaran anda',
    emptyFeed: 'Makanan akan muncul di sini',
    emptyFollowing: 'Ikuti orang atau kongsi makanan dari diari anda.',
    emptyDiscover: 'Lebih banyak makanan akan datang',
    emptyPeople: 'Tiada orang ditemui',
    emptyPosts: 'Belum ada siaran',
    emptyComments: 'Mulakan perbualan',
    emptyConnections: 'Belum ada orang',
    emptyBlocked: 'Tiada orang disekat',
    emptyNotifications: 'Anda sudah lihat semuanya',
    unavailable: 'Ini tidak lagi tersedia',
    loadMore: 'Muat lagi',
    end: 'Anda sudah lihat semuanya',
    loading: 'Memuatkan',
    retry: 'Cuba lagi',
    failed: 'Tidak dapat memuatkan ini',
    saveFailed: 'Tidak dapat menyimpan. Cuba lagi.',
    offline: 'Sambung untuk teruskan',
    unknownPerson: 'Seseorang',
    options: 'Pilihan',
    profileRequired: 'Cipta profil awam untuk turut serta.',
    characterCount: '{{count}} / {{limit}}',
    reviewFailed: 'Disimpan, menunggu semakan.',
  },
  common: {
    action: {
      continue: 'Teruskan',
