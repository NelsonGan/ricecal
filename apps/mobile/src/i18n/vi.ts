...
export const vi = {
  social: {
    rejectedBody: 'Sửa nội dung hoặc ảnh rồi thử lại.',
    handleTaken: 'Tên người dùng này đã được sử dụng.',
    feed: 'Bảng tin',
    following: 'Đang theo dõi',
    discover: 'Khám phá',
    myFoods: 'Món của tôi',
    people: 'Tìm người',
    suggestions: 'Người nên theo dõi',
    search: 'Tìm tên người dùng',
    ...
    handleHint: '3 đến 24 chữ thường, số hoặc dấu gạch dưới.',
    displayName: 'Tên',
    bio: 'Giới thiệu',
    avatar: 'Chọn ảnh',
    removeAvatar: 'Xóa ảnh',
    handleInvalid: 'Dùng 3 đến 24 chữ thường, số hoặc dấu gạch dưới.',
    ...
    posts_one: '{{count}} bài đăng',
    posts_other: '{{count}} bài đăng',
    followers_one: '{{count}} người theo dõi',
    followers_other: '{{count}} người theo dõi',
    follow: 'Theo dõi',
    ...
    caption: 'Chú thích',
    captionPlaceholder: 'Chia sẻ đôi lời về bữa ăn',
    audience: 'Ai có thể xem?',
    everyone: 'Mọi người',
    followersOnly: 'Người theo dõi',
    ...
    sourceDelete: 'Xóa món này cũng xóa bài đăng trên bảng tin và bình luận.',
    like: 'Thích',
    unlike: 'Bỏ thích',
    ...
    deleteCommentBody: 'Bình luận này sẽ bị xóa.',
    pending: 'Đang chờ duyệt',
    rejected: 'Cần chỉnh sửa',
    quarantined: 'Đang xem xét',
    approved: 'Đã đăng',
    pendingBody: 'Chỉ bạn thấy nội dung này cho đến khi được duyệt.',
    retryReview: 'Duyệt lại',
    block: 'Chặn',
    blockBody: 'Hai bên sẽ không còn thấy nhau ở đây. Quan hệ theo dõi sẽ bị xóa.',
    blocked: 'Người đã chặn',
    unblock: 'Bỏ chặn',
    unblockBody: 'Quan hệ theo dõi sẽ không được khôi phục.',
    report: 'Báo cáo',
    reported: 'Đã báo cáo',
    reportTitle: 'Vì sao bạn báo cáo nội dung này?',
    spam: 'Spam',
    inappropriate: 'Nội dung không phù hợp',
    notifications: 'Thông báo',
    unread: 'Chưa đọc',
    unreadNotifications_one: '{{count}} thông báo chưa đọc',
    unreadNotifications_other: '{{count}} thông báo chưa đọc',
    unreadNotificationsOverflow: '99 thông báo chưa đọc trở lên',
    markRead: 'Đánh dấu đã đọc',
    notificationFollow: '{{name}} đã theo dõi bạn',
    notificationLike: '{{name}} đã thích bài của bạn',
    notificationComment: '{{name}} đã bình luận bài của bạn',
    emptyFeed: 'Bữa ăn sẽ xuất hiện ở đây',
    emptyFollowing: 'Theo dõi người khác hoặc chia sẻ bữa ăn từ nhật ký.',
    emptyDiscover: 'Sắp có thêm bữa ăn',
    emptyPeople: 'Không tìm thấy ai',
    emptyPosts: 'Chưa có bài đăng',
    emptyComments: 'Bắt đầu trò chuyện',
    emptyConnections: 'Chưa có ai',
    emptyBlocked: 'Chưa chặn ai',
    emptyNotifications: 'Bạn đã xem hết',
    unavailable: 'Nội dung này không còn khả dụng',
    loadMore: 'Tải thêm',
    end: 'Bạn đã xem hết',
    loading: 'Đang tải',
    retry: 'Thử lại',
    failed: 'Không thể tải nội dung này',
    saveFailed: 'Không thể lưu. Hãy thử lại.',
    offline: 'Kết nối để tiếp tục',
    unknownPerson: 'Ai đó',
    options: 'Tùy chọn',
    profileRequired: 'Tạo hồ sơ công khai để tham gia.',
    characterCount: '{{count}} / {{limit}}',
    reviewFailed: 'Đã lưu, đang chờ duyệt.',
  },
  common: {
    action: {
      continue: 'Tiếp tục',
  ...
  profile: {
    ...
    subscription: {
      ...
      cancelBody: 'Huỷ ở trang cửa hàng sẽ mở ra. Bạn vẫn giữ Pro tới hết kỳ.',
  ...
  paywall: {
    ...
    hard: {
      ...
      smallPrintYearly: 'Miễn phí {{duration}}, sau đó {{price}} mỗi năm.',
      smallPrintMonthly: 'Miễn phí {{duration}}, sau đó {{price}} mỗi tháng.',
      ...
      trialDuration: {
        ...
        week_one: '{{count}} tuần',
        week_other: '{{count}} tuần',
        month_one: '{{count}} tháng',
        month_other: '{{count}} tháng',
        year_one: '{{count}} năm',
        year_other: '{{count}} năm',
      },
    ...
    welcome: {
      ...
      body: 'Bạn được dùng thử miễn phí {{duration}}. Mọi thứ đã mở khoá.',
      bodyTrialUnknown: 'Bạn bắt đầu dùng thử miễn phí ngay. Mọi thứ đã mở khoá.',
