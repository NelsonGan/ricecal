...
export const id = {
  ...
  profile: {
    ...
    account: {
      ...
      saved: 'Nama disimpan',
      saveFailed: 'Nama gagal disimpan',
      copy: 'Salin',
  ...
  paywall: {
    ...
    hard: {
      ...
      smallPrintYearly: 'Gratis {{duration}}, lalu {{price}} per tahun.',
      smallPrintMonthly: 'Gratis {{duration}}, lalu {{price}} per bulan.',
    ...
    welcome: {
      ...
      body: 'Uji coba gratismu berlangsung {{duration}}. Semuanya terbuka.',
      bodyTrialUnknown: 'Uji coba gratismu mulai sekarang. Semuanya terbuka.',
  ...
  recipes: {
    ...
    edit: {
      ...
      removeStep: 'Hapus langkah {{count}}',
      save: 'Simpan makanan',
