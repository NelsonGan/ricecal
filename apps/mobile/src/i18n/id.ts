...
export const id = {
  social: {
    rejectedBody: 'Edit teks atau foto, lalu coba lagi.',
    handleTaken: 'Nama pengguna ini sudah dipakai.',
    feed: 'Linimasa',
    following: 'Mengikuti',
    discover: 'Jelajahi',
    ...
    handleHint: '3 hingga 24 huruf kecil, angka, atau garis bawah.',
    displayName: 'Nama',
    bio: 'Bio',
    avatar: 'Pilih foto',
    removeAvatar: 'Hapus foto',
    handleInvalid: 'Gunakan 3 hingga 24 huruf kecil, angka, atau garis bawah.',
    ...
    back: 'Kembali',
    followers: 'Pengikut',
    posts_one: '{{count}} postingan',
    posts_other: '{{count}} postingan',
    ...
    audience: 'Siapa yang bisa melihat?',
    ...
    sourceDelete: 'Menghapus makanan ini juga menghapus postingan linimasa beserta komentarnya.',
    like: 'Suka',
    unlike: 'Batal suka',
    ...
    deleteCommentBody: 'Komentar ini akan dihapus.',
    pending: 'Menunggu peninjauan',
    rejected: 'Perlu perubahan',
    quarantined: 'Sedang ditinjau',
    approved: 'Dipublikasikan',
    pendingBody: 'Hanya Anda yang dapat melihatnya sampai disetujui.',
    retryReview: 'Tinjau lagi',
    block: 'Blokir',
    blockBody: 'Anda tidak akan saling melihat lagi di sini. Hubungan mengikuti dihapus.',
    blocked: 'Orang yang diblokir',
    unblock: 'Buka blokir',
    ...
    unread: 'Belum dibaca',
    unreadNotifications_one: '{{count}} notifikasi belum dibaca',
    unreadNotifications_other: '{{count}} notifikasi belum dibaca',
    unreadNotificationsOverflow: '99 atau lebih notifikasi belum dibaca',
    ...
    emptyFollowing: 'Ikuti orang atau bagikan makanan dari jurnal Anda.',
    emptyDiscover: 'Makanan lainnya segera hadir',
    emptyPeople: 'Tidak ada orang ditemukan',
    emptyPosts: 'Belum ada postingan',
    emptyComments: 'Mulai percakapan',
    emptyConnections: 'Belum ada orang',
    emptyBlocked: 'Tidak ada yang diblokir',
    emptyNotifications: 'Anda sudah melihat semuanya',
    unavailable: 'Ini tidak lagi tersedia',
    loadMore: 'Muat lainnya',
    end: 'Anda sudah melihat semuanya',
    loading: 'Memuat',
    retry: 'Coba lagi',
    failed: 'Tidak dapat memuat ini',
    saveFailed: 'Tidak dapat menyimpan. Coba lagi.',
    offline: 'Hubungkan untuk melanjutkan',
    unknownPerson: 'Seseorang',
    options: 'Opsi',
    profileRequired: 'Buat profil publik untuk ikut serta.',
    characterCount: '{{count}} / {{limit}}',
    reviewFailed: 'Tersimpan, menunggu peninjauan.',
  },
  common: {
    action: {
      continue: 'Lanjutkan',
