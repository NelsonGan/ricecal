...
export const ja = {
  social: {
    rejectedBody: '文章や写真を修正して、もう一度お試しください。',
    handleTaken: 'このユーザー名は使用されています。',
    feed: 'フィード',
    following: 'フォロー中',
    discover: '見つける',
    myFoods: 'マイフード',
    ...
    handle: 'ユーザー名',
    handleHint: '半角英小文字、数字、アンダースコアで3〜24文字。',
    displayName: '名前',
    bio: '自己紹介',
    avatar: '写真を選ぶ',
    removeAvatar: '写真を削除',
    handleInvalid: '半角英小文字、数字、アンダースコアで3〜24文字にしてください。',
    ...
    back: '戻る',
    followers: 'フォロワー',
    posts_one: '投稿{{count}}件',
    posts_other: '投稿{{count}}件',
    followers_one: 'フォロワー{{count}}人',
    followers_other: 'フォロワー{{count}}人',
    follow: 'フォロー',
    unfollow: 'フォロー解除',
    ...
    post: '投稿',
    deletePost: '投稿を削除',
    deletePostBody: '日記の記録は残ります。',
    sourceDelete: 'この食事を削除すると、フィードの投稿とコメントも削除されます。',
    like: 'いいね',
    unlike: 'いいねを取り消す',
    likes_one: 'いいね{{count}}件',
    likes_other: 'いいね{{count}}件',
    ...
    quarantined: '審査中',
    approved: '公開済み',
    pendingBody: '承認されるまではあなただけに表示されます。',
    retryReview: '再審査を依頼',
    block: 'ブロック',
    blockBody: 'ここではお互いに表示されなくなります。フォロー関係も削除されます。',
    blocked: 'ブロックしたユーザー',
    unblock: 'ブロック解除',
    unblockBody: 'フォロー関係は復元されません。',
    report: '報告',
    reported: '報告しました',
    reportTitle: '報告する理由は？',
    spam: 'スパム',
    ...
    notifications: '通知',
    unread: '未読',
    unreadNotifications_one: '未読の通知{{count}}件',
    unreadNotifications_other: '未読の通知{{count}}件',
    unreadNotificationsOverflow: '未読の通知99件以上',
    markRead: '既読にする',
    notificationFollow: '{{name}}さんがあなたをフォローしました',
    notificationLike: '{{name}}さんが投稿にいいねしました',
    notificationComment: '{{name}}さんが投稿にコメントしました',
    emptyFeed: '食事がここに表示されます',
    emptyFollowing: '誰かをフォローするか、日記から食事をシェアしましょう。',
    emptyDiscover: '新しい食事をお楽しみに',
    emptyPeople: 'ユーザーが見つかりません',
    emptyPosts: 'まだ投稿がありません',
    emptyComments: 'コメントしてみましょう',
    emptyConnections: 'まだユーザーがいません',
    emptyBlocked: 'ブロックしたユーザーはいません',
    emptyNotifications: 'すべて確認しました',
    unavailable: 'この内容は表示できません',
    loadMore: 'もっと見る',
    end: 'すべて表示しました',
    loading: '読み込み中',
    retry: '再試行',
    ...
    unknownPerson: '誰か',
    options: 'オプション',
    profileRequired: '参加するには公開プロフィールを作成してください。',
    characterCount: '{{count}} / {{limit}}',
    reviewFailed: '保存しました。審査をお待ちください。',
  },
  common: {
    action: {
      continue: '続ける',
  ...
  logging: {
    ...
    barcode: {
      ...
      labelTitle: '栄養成分表示を撮影',
      labelPrompt: 'この商品はまだ登録がありません。裏面を向けてください。数値を読み取ります。',
    },
    ...
    search: {
      ...
      pastEmptyBody: '記録した食事がここに並び、すぐにまた追加できます。',
      pastNoMatchBody: '食べたもののなかに一致するものはありません。',
      pastOfflineBody: '記録はサーバーにあります。オンラインに戻ればすぐ読み込まれます。',
      place: {
        mamak: 'ママック',
        kopitiam: 'コピティアム',
        hawker: '屋台',
    ...
    detail: {
      ...
      fixNoCalories: 'カロリーは変わらないので、何も動いていません',
      fixNotUnderstood: 'うまく読み取れませんでした。別の言い方で試してください',
      fixNoMatch: 'その料理を割り出せませんでした。食事はそのままです',
      ...
      addPartFailed: '追加できませんでした。もう一度お試しください',
      addPartTyped: 'この記録はご自分で入力したカロリーを使っているため、内訳にできません',
      ...
      removeOf: '{{name}} を外す',
      replacePart: '差し替え',
      replaceOf: '{{name}} を差し替える',
      partReplaced: '{{food}} がかわりにお皿にあります',
      editKcal: 'カロリー',
  ...
  profile: {
    ...
    account: {
      ...
      goesRecipes: '公開したものも含め、自分で書いたフードすべて',
    ...
    subscription: {
      ...
      freeBody: '1 日 {{scans}} 回の撮影、自分のフード {{recipes}} 件、直近 1 週間のトレンド。',
  ...
  paywall: {
    ...
    hard: {
      ...
      smallPrintYearly: '{{duration}}無料、その後は年 {{price}}。',
      smallPrintMonthly: '{{duration}}無料、その後は月 {{price}}。',
    ...
    welcome: {
      title: '準備完了です。食べましょう。',
      body: '無料期間は {{duration}} です。すべて使えます。',
      bodyTrialUnknown: '無料期間が今から始まります。すべて使えます。',
      bodyActive: 'すべて使えます。',
  ...
  recipes: {
    ...
    edit: {
      ...
      replacePhotoBody: 'このフードの写真は削除されます。',
      ...
      stepsWrite: '調理手順を追加',
      stepLabel: '手順 {{count}}',
      stepPlaceholder: 'この手順ですること',
      addStep: '手順を追加',
      removeStep: '手順 {{count}} を削除',
      save: 'フードを保存',
      saved: 'フードを保存しました',
    ...
    report: {
      ...
      dangerous: '調理や飲食に危険',
      stolen: '他人の作品',
      block: '{{name}} のフードをすべて非表示',
      done: '報告しました。もう表示されません。',
      blocked: '非表示にしました。この人のフードはもう表示されません。',
    ...
    review: {
      checking: 'フードを確認しています…',
      approved: 'フードがコミュニティに公開されました',
      rejected: '未公開：{{reason}}',
