...
export const fil = {
  social: {
    rejectedBody: 'Baguhin ang teksto o larawan, saka subukan muli.',
    handleTaken: 'May gumagamit na ng username na ito.',
    feed: 'Feed',
    following: 'Sinusundan',
    discover: 'Tuklasin',
    myFoods: 'Mga pagkain ko',
    people: 'Maghanap ng tao',
    suggestions: 'Mga taong puwedeng sundan',
    search: 'Maghanap ng username',
    profile: 'Profile',
    ...
    followers_one: '{{count}} tagasunod',
    followers_other: '{{count}} tagasunod',
    follow: 'Sundan',
    unfollow: 'I-unfollow',
    followsYou: 'Sinusundan ka',
    ...
    caption: 'Caption',
    captionPlaceholder: 'Kuwento tungkol sa pagkain mo',
    audience: 'Sino ang makakakita?',
    everyone: 'Lahat',
    ...
    sourceDelete: 'Mabubura rin ang post sa feed at mga komento kapag binura ang pagkaing ito.',
    like: 'Gusto',
    unlike: 'Alisin ang gusto',
    likes_one: '{{count}} gusto',
    likes_other: '{{count}} gusto',
    ...
    deleteCommentBody: 'Mabubura ang komentong ito.',
    pending: 'Naghihintay ng pagsusuri',
    rejected: 'Kailangang baguhin',
    quarantined: 'Sinusuri',
    approved: 'Na-publish',
    pendingBody: 'Ikaw lang ang makakakita nito hanggang maaprubahan.',
    retryReview: 'Ipasuri muli',
    block: 'I-block',
    blockBody: "Hindi na kayo magkakakita rito. Aalisin ang pagsunod sa isa't isa.",
    blocked: 'Mga naka-block',
    unblock: 'I-unblock',
    unblockBody: "Hindi maibabalik ang pagsunod sa isa't isa.",
    report: 'I-report',
    reported: 'Nai-report',
    ...
    unreadNotifications_one: '{{count}} hindi pa nababasang notification',
    unreadNotifications_other: '{{count}} hindi pa nababasang notification',
    unreadNotificationsOverflow: '99 o higit pang hindi pa nababasang notification',
    markRead: 'Markahang nabasa',
    notificationFollow: 'Sinundan ka ni {{name}}',
    notificationLike: 'Nagustuhan ni {{name}} ang post mo',
    notificationComment: 'Nagkomento si {{name}} sa post mo',
    emptyFeed: 'Lilitaw rito ang mga pagkain',
    emptyFollowing: 'Sundan ang iba o magbahagi ng pagkain mula sa talaarawan.',
    emptyDiscover: 'May darating pang mga pagkain',
    emptyPeople: 'Walang nahanap',
    emptyPosts: 'Wala pang post',
    emptyComments: 'Simulan ang usapan',
    emptyConnections: 'Wala pa rito',
    emptyBlocked: 'Walang naka-block',
    emptyNotifications: 'Nabasa mo na ang lahat',
    unavailable: 'Hindi na ito available',
    loadMore: 'Mag-load pa',
    end: 'Nakita mo na ang lahat',
    loading: 'Naglo-load',
    retry: 'Subukan muli',
    failed: 'Hindi ma-load ito',
    saveFailed: 'Hindi ma-save. Subukan muli.',
    offline: 'Kumonekta para magpatuloy',
    unknownPerson: 'Isang tao',
    options: 'Mga opsyon',
    profileRequired: 'Gumawa ng pampublikong profile para makilahok.',
    characterCount: '{{count}} / {{limit}}',
    reviewFailed: 'Na-save, naghihintay ng pagsusuri.',
  },
  common: {
    action: {
      continue: 'Magpatuloy',
