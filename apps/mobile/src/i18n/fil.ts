...
export const fil = {
  ...
  logging: {
    ...
    detail: {
      ...
      fixNoCalories: 'Hindi nito binabago ang calories, kaya walang nagbago',
      fixNotUnderstood: 'Hindi mabasa iyon. Subukang sabihin sa ibang paraan',
      fixNoMatch: 'Hindi matukoy ang ulam na iyon. Hindi nagbago ang pagkain mo',
      ...
      replacePart: 'Palitan',
      replaceOf: 'Palitan ang {{name}}',
      partReplaced: 'Nasa plato na ang {{food}} bilang kapalit',
      editKcal: 'Calories',
  ...
  profile: {
    ...
    account: {
      ...
      saved: 'Na-save ang pangalan',
      saveFailed: 'Hindi ma-save ang pangalan',
      copy: 'Kopyahin',
  ...
  paywall: {
    ...
    hard: {
      ...
      smallPrintYearly: 'Libre nang {{duration}}, tapos {{price}} kada taon.',
      smallPrintMonthly: 'Libre nang {{duration}}, tapos {{price}} kada buwan.',
      ...
      trialDuration: {
        day_one: '{{count}} araw',
        day_other: '{{count}} araw',
        week_one: '{{count}} linggo',
        week_other: '{{count}} linggo',
        month_one: '{{count}} buwan',
        month_other: '{{count}} buwan',
        year_one: '{{count}} taon',
        year_other: '{{count}} taon',
      },
    ...
    welcome: {
      ...
      body: 'Libre ang trial mo nang {{duration}}. Bukas ang lahat.',
      bodyTrialUnknown: 'Nagsisimula na ngayon ang libreng trial mo. Bukas ang lahat.',
  ...
  recipes: {
    ...
    edit: {
      ...
      stepLabel: 'Hakbang {{count}}',
      stepPlaceholder: 'Ano ang gagawin sa hakbang na ito?',
      addStep: 'Magdagdag ng hakbang',
      removeStep: 'Alisin ang hakbang {{count}}',
